	...
	<head>
		...
		<style>
			* {
			...
			#mainBodyTable tfoot .relativeContainer .sumTable td {
				padding: 10px 14px;
			}
		</style>
	</head>
		...
		<div class="page">
			<div class="pageBody">
				<table id="mainBodyTable">
					<thead>
						<tr>
							<th colspan="5">
								...
								<table class="tableHeaderTop top">
								<tr>
							<td
								class="bRight"
								width="10%">
					...
					<tbody id="table-body">
						<tr>
							<td width="10%"	id="margin-row">
								<!-- Margin row -->
							</td>
							<td width="16%"	id="margin-row">
								<!-- Margin row -->
							</td>
							<td width=""	id="margin-row">
								<!-- Margin row -->
							</td>
							<td width="18%"	id="margin-row">
								<!-- Margin row -->
							</td>
							<td width="18%"	id="margin-row">
								<!-- Margin row -->
					...
					<tfoot>
						<tr>
							...
							<div class="relativeContainer bottom">
								<table class="tableHeaderTop sumTable bottom">
									<tr>
										<td
											class="tdRight"
											width="51%">
